...
后续规则更新（2026-09-22）：全量刷新现按[缓存条目合并规格](../superpowers/specs/2026-09-22-guide-refresh-retention-design.md)保留全部旧景点和美食并追加新增；5 景点 / 6 美食只限制单次生成，累计缓存允许超过，城市图片总量仍最多 100 张。下文 33 张说明仅对应当时版本。
