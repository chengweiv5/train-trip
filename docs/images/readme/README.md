...
- 邯郸介绍、路线和照片来自电脑端豆包搜索、DeepSeek 整理的成功样本，再导入模拟器缓存采集界面。没有通过手机完整生成流程采集，也没有操作个人手机；这些图片不能作为真机生成成功的验收证据。
...
| [plans.jpg](plans.jpg) | 导入成功样本后的模拟器演示：邯郸一日路线、一日/两日切换、景点顺序和攻略原文；不代表个人手机已生成路线 |
