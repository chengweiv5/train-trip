...
0.2.0 新增天津、济南、青岛、大同、洛阳五城目的地灵感：结果卡片展示实景图与亮点，详情提供景点、美食、一日/两日玩法和来源署名，资料离线可读。其他城市保留查票功能。已通过核心和模拟器验证；2026-09-19 已覆盖安装到 Mate 60 Pro，版本与启动回读成功，原有筛选偏好保持一致。详见 [五城灵感验收](docs/verification/2026-09-19-destination-inspiration.md)。
